    ...
    <div className="boroughItem">
      ...
      <div class="container">
        <div class="row">
          ...
          <img className="us-img" src={process.env.PUBLIC_URL + "/images/Yes.png"} width="20" height="40" alt="Yes"></img>
          ...
          <img className="us-img"  src={process.env.PUBLIC_URL + "/images/No.png"} width="20" height="40" alt="No"></img>
