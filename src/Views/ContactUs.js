  ...
  return (
    <div className="center">
      <div className="whoarewe">
        <h1>Who Are We?</h1>
        <img src={process.env.PUBLIC_URL + "/images/US.png"} width="60" height="40" alt="5 happy girls"></img>
      ...
      <div className="whoarewe green">
         <img src={process.env.PUBLIC_URL + "/images/tree_sm.png"} width="60" height="40" alt="logo"></img>
